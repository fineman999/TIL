...
openssl req -newkey rsa:4096 -nodes -keyout client-key.pem -out client-req.pem -subj "/C=KR/ST=SEUOL/L=MAPO/O=CHAN/OU=Study/CN=*.client.site/emailAddress=client@naver.com"

# 5. Use CA's private key to sign client's CSR and generate client's certificate
