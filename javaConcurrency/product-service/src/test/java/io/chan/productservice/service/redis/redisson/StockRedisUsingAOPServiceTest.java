...
class StockRedisUsingAOPServiceTest extends AcceptanceTest {
  @Autowired private StockRedisUsingAOPService stockService;
  @Autowired private StockRepository stockRepository;

  @Test
  @DisplayName("redisson aop 를 이용하여 재고를 감소시킨다.")
  void decrease() {
  ...
  @Test
  @DisplayName("동시에 100개의 재고를 감소시킨다. - redisson aop")
