...
public class PaymentPersistenceServiceTest {
    ...
    private void setUpPaymentResponse() {
        paymentResponse = new PaymentResponse(
                ...
                new BigDecimal("0.00"),
                0,
                List.of(new PaymentResponse.Cancel(
                ...
                new PaymentResponse.MobilePhone(
                        "01012341234",
                        "PENDING",
                        "https://receipt.url"
                ),
                new PaymentResponse.GiftCertificate(
                        "12345678",
                        "PENDING"
                ),
                new PaymentResponse.Transfer(
                        "01",
                        "PENDING"
                ),
                new PaymentResponse.EasyPay(
                        "토스페이",
                        new BigDecimal("0.00"),
                        new BigDecimal("0.00")
                ),
                ...
                List.of(new PaymentResponse.CashReceipt(
                        "INCOME",
                        "RECEIPT_456",
                        "987654321",
                        "https://receipt.url/2",
    ...
    class SavePaymentTest {
        ...
        void savePayment_successWithAllNestedObjects() {
            ...
            assertAll("결제 및 중첩 객체 검증",
                    ...
                    () -> assertThat(savedPayment.getRequestedAt()).isEqualTo(paymentResponse.requestedAt()),
                    () -> assertThat(savedPayment.getApprovedAt()).isEqualTo(paymentResponse.approvedAt()),
